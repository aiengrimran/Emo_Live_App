...
const token =
  '007eJxTYLjQ4xiR/77WfV/uc/GLXjE3jvlp83eJ+H4OMd5/Y19l6EQFhuQkQ3MLC1PLtDQDQxMDgxQLg5RkE4OUVENz87TUlKTkY3ap6Q2BjAyxb/JZGRkgEMRnYUjKTM9nYAAAd78gMA==';
const channelName = 'bigo';
...
const LiveStreaming = () => {
  ...
  return (
    <SafeAreaView style={styles.main}>
      ...
      <Button title="update Uid" onPress={updateToken} />
      <Text style={{marginVertical: 20}}>{uid}</Text>
