...
const Chat3 = () => {
  ...
  //   const appKey =
  // '007eJxTYNg111A+egKD4/3cOCu7OX4Mm73rghxkKuJ7hZJu/XUPEVVgSE4yNLewMLVMSzMwNDEwSLEwSEk2MUhJNTQ3T0tNSUq+Oq8wvSGQkaGlIoKJkYGVgZGBiQHEZ2AAAKrnGxY=';
  ...
  const [chatToken, setChatToken] = React.useState(
    '007eJxTYPj/3e3YKWXmPRobVmUe45x+IOT4MuYu5j8fHm692DTZunGVAkNykqG5hYWpZVqagaGJgUGKhUFKsolBSqqhuXlaakpSsuLKwvSGQEYGoSM+zIwMrAyMQAjiqzAkpxonpxgZGugmm5oa6hoapqbpWhobWepaGlokG5gYGpmmJqUBAF6oKQ4=',
  );
  ...
  const test = async () => {
    try {
      const res = await ChatClient.getInstance().init(
        new ChatOptions({
          appKey: appKey,
        }),
      );
  ...
  return (
    <SafeAreaView>
      ...
      <ScrollView>
        ...
        <View style={styles.buttonCon}>
          <Text style={styles.btn2} onPress={test}>
            SEND TEXT
          </Text>
        </View>
        <View>
